...
*    http://kernscores.stanford.edu/browse?l=haydn/quartets

with mirrors at:
*    http://kern.humdrum.org/browse?l=haydn/quartets
*    http://kern.ccarh.org/browse?l=haydn/quartets
...
```bash
   humcat -s h://haydn/quartets | census -k
```
