## humdrum-string-quartets Makefile
##
...
##                for the quartets of Joseph Haydn.
##
...
#           git clone https://github.com/musedata/humdrum-haydn-quartets
#
...
kernscores: humdrum-extras-check
	mkdir -p kernscores; (cd kernscores && humsplit h://haydn/quartets)
	@echo "[0;32m"
...
ifeq ($(shell which curl),)
	...
	for file in kern/*.krn; do \
	   ...
	   curl \
	      "http://kern.humdrum.org/data?l=haydn/quartets&file=$$TBASE.krn&format=pdf" \
...
ifeq ($(wildcard .git),)
	...
	@echo "***    [0;32mgit clone https://github.com/musedata/humdrum-haydn-quartets[0;31m"
	@echo "[0m"
	exit 1
endif
